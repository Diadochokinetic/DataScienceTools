...
class Imputer(TransformerMixin):
    ...
    ---------
        ...
        fit(X, y=None):
            fit the Imputer by genereating the values to impute, either takes manual values or values generated by a metric for numerical values or the most frequent value for non numeric values
